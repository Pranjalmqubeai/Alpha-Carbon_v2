    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section className="px-4">
        <div className="max-w-6xl mx-auto py-16 md:py-20 grid md:grid-cols-2 gap-10 items-center">
          {/* Left content */}
          <div>
            <div className="inline-flex items-center gap-2 text-emerald-700 bg-emerald-50 border border-emerald-200 px-3 py-1 rounded-full text-xs font-semibold">
              Carbon Intelligence • Project Performance
            </div>

            <h1 className="mt-4 text-4xl md:text-5xl font-black leading-tight">
              Manage Your{" "}
              <span className="text-emerald-600">Carbon Projects</span> with
              Confidence
            </h1>

            <p className="mt-4 text-slate-600 text-lg">
              AlphaCarbon helps enterprises monitor carbon generation,
              certification, and performance reports — all in one intelligent
              workspace.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link
                to="/projects/new"
                className="inline-flex items-center gap-2 px-5 py-3 rounded-lg border border-slate-300 hover:bg-slate-50"
              >
            ...
            {/* Email capture */}
            <form onSubmit={handleNotify} className="mt-8 max-w-md">
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-emerald-200 focus:border-emerald-400 outline-none"
                  />
                </div>
                <button
                  type="submit"
                  className="px-4 py-3 rounded-lg bg-slate-900 text-white hover:bg-black"
                >
                  Notify me
                </button>
              </div>
            ...
            {[
              {
                ...
                text: "Manage all certification documents and validation audits in one place.",
                color: "bg-emerald-100 text-emerald-700 border-emerald-200",
              },
              {
                icon: BarChart3,
                title: "Performance Analytics",
                text: "Track emission reductions and project KPIs over time.",
                color: "bg-blue-100 text-blue-700 border-blue-200",
              },
              {
                icon: ClipboardList,
                title: "Reporting & Compliance",
                text: "Generate MRV-ready carbon reports for internal and external audits.",
                color: "bg-emerald-100 text-emerald-700 border-emerald-200",
              },
              {
                icon: LineChart,
                title: "Carbon Generation Insights",
                text: "Forecast credit generation using AI-driven intelligence.",
                color: "bg-slate-100 text-slate-700 border-slate-200",
              },
            ].map(({ icon: Icon, title, text, color }, i) => (
              <div
                key={i}
                className="rounded-2xl border border-slate-200 p-5 hover:border-emerald-300 transition-all"
              >
                <div
                  className={`w-10 h-10 rounded-lg ${color} flex items-center justify-center mb-3 border`}
                >
      ...
      <section className="border-t border-slate-200 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 py-10 grid sm:grid-cols-3 gap-4">
          <Link
            to="/projects"
            className="rounded-xl bg-white border border-slate-200 p-5 hover:border-emerald-300"
          >
            <div className="text-sm font-semibold">View All Projects</div>
            <p className="text-sm text-slate-600 mt-1">
              Track ongoing certifications and performance metrics.
            </p>
          </Link>
          <Link
            to="/reports"
            className="rounded-xl bg-white border border-slate-200 p-5 hover:border-emerald-300"
          >
            <div className="text-sm font-semibold">Generate Reports</div>
            <p className="text-sm text-slate-600 mt-1">
              Download compliance-ready performance and emission reports.
            </p>
          </Link>
          <Link
            to="/certifications"
            className="rounded-xl bg-white border border-slate-200 p-5 hover:border-emerald-300"
          >
            <div className="text-sm font-semibold">Certification Records</div>
            <p className="text-sm text-slate-600 mt-1">
              Manage validation, verification, and issuance logs.
            </p>
          </Link>
        </div>
      </section>
      ...
      <footer className="border-t border-slate-200">
        <div className="max-w-6xl mx-auto px-4 py-8 text-sm text-slate-500 flex flex-wrap items-center justify-between gap-3">
          <div>© {new Date().getFullYear()} AlphaCarbon</div>
          <div className="flex gap-4">
            ...
            <a
              href="mailto:hello@alphacarbon.com"
